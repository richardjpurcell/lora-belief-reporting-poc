...
This document preserves the chronological milestone history that previously lived
in the repository README.

The README is now reserved for a short current-facing project overview,
reproduction pointers, and scope boundaries.
