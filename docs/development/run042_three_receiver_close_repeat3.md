# Run 042 Three-Receiver Close Indoor Repeat 3

## Purpose

Run 042 is the first data run in the final three-receiver experiment design.
...
Use separate serial logger sessions:
    ...
    logs/rx_run_040_close_repeat3_rxa_lora32.csv
    logs/rx_run_040_close_repeat3_rxb_tbeam.csv
    logs/rx_run_040_close_repeat3_rxc_tbeam.csv

## Planned Parsed Logs

    logs/parsed_run_040_close_repeat3_rxa_lora32.csv
    logs/parsed_run_040_close_repeat3_rxa_lora32_rejects.csv
    logs/parsed_run_040_close_repeat3_rxb_tbeam.csv
    logs/parsed_run_040_close_repeat3_rxb_tbeam_rejects.csv
    logs/parsed_run_040_close_repeat3_rxc_tbeam.csv
    logs/parsed_run_040_close_repeat3_rxc_tbeam_rejects.csv

## Planned Analysis Outputs

Receiver-specific manifest summaries and validations:

    outputs/run042_close_repeat3_rxa_manifest_replay_summary.csv
    outputs/run042_close_repeat3_rxa_manifest_replay_summary.json
    outputs/run042_close_repeat3_rxa_manifest_replay_validation.json
    outputs/run042_close_repeat3_rxb_manifest_replay_summary.csv
    outputs/run042_close_repeat3_rxb_manifest_replay_summary.json
    outputs/run042_close_repeat3_rxb_manifest_replay_validation.json
    outputs/run042_close_repeat3_rxc_manifest_replay_summary.csv
    outputs/run042_close_repeat3_rxc_manifest_replay_summary.json
    outputs/run042_close_repeat3_rxc_manifest_replay_validation.json

Three-receiver packet-identity comparison:

    outputs/run042_close_repeat3_three_receiver_comparison_summary.csv
    outputs/run042_close_repeat3_three_receiver_comparison_summary.json
    outputs/run042_close_repeat3_three_receiver_common_window_comparison_summary.csv
    outputs/run042_close_repeat3_three_receiver_common_window_comparison_summary.json
...
Run 042 is a receiver-side replay observation, not a ground-truth transmitted-packet record.
